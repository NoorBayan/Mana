...
3.  **Large-Scale Application:** After a rigorous validation phase on unseen data, the trained system was used to analyze the wider Diwan collection. It assigned relevant thematic tags to each poem based on our [comprehensive thematic schema](https://github.com/NoorBayan/Mana/blob/main/corpus/corpus_metadata/hierarchical_thematic_taxonomy.json), also calculating a relevance score for each assigned theme.
